...
import com.hj.mapper.FeedbackCategoryMapper;
...
public class FeedbackCategoryServiceImpl extends ServiceImpl<FeedbackCategoryMapper, FeedbackCategory>
    ...
    public void insertFeedbackCategory(FeedbackCategoryBo bo) {
        if (bo.getPid() == null) {
            log.error("FeedbackCategoryServiceImpl===>insertFeedbackCategory:" + ResponseStatusEnum.FEEDBACK_CATEGORY_PARENT_LABEL_ERROR);
            GraceJSONResult.errorCustom(ResponseStatusEnum.FEEDBACK_CATEGORY_PARENT_LABEL_ERROR);
        }
        if (bo.getCateName() == null) {
            log.error("FeedbackCategoryServiceImpl===>insertFeedbackCategory:" + ResponseStatusEnum.FEEDBACK_CATEGORY_NAME_ERROR);
            GraceJSONResult.errorCustom(ResponseStatusEnum.FEEDBACK_CATEGORY_NAME_ERROR);
        }
        FeedbackCategory feedbackCategory = new FeedbackCategory();
        if (bo.getPid() != 0) {
            FeedbackCategory category = this.getById(bo.getPid());
            if (category.getPid() != 0) {
                log.error("FeedbackCategoryServiceImpl===>insertFeedbackCategory:" + ResponseStatusEnum.FEEDBACK_CATEGORY_ERROR);
        ...
        if (index == 0) {
            log.error("FeedbackCategoryServiceImpl===>insertFeedbackCategory:" + ResponseStatusEnum.SYSTEM_OPERATION_ERROR);
    ...
    public FeedbackCategory1Vo getFeedbackCategoryById(Integer feedbackCategoryId) {
        if (feedbackCategoryId == null) {
            log.error("FeedbackCategoryServiceImpl===>getFeedbackCategoryById:" + ResponseStatusEnum.FEEDBACK_CATEGORY_ID_ERROR);
            GraceJSONResult.errorCustom(ResponseStatusEnum.FEEDBACK_CATEGORY_ID_ERROR);
        }
    ...
    public void updateFeedbackCategory(FeedbackCategoryBo bo) {
        if (bo.getFeedbackCategoryId() == null) {
            log.error("FeedbackCategoryServiceImpl===>updateFeedbackCategory:" + ResponseStatusEnum.FEEDBACK_CATEGORY_ID_ERROR);
            GraceJSONResult.errorCustom(ResponseStatusEnum.FEEDBACK_CATEGORY_ID_ERROR);
        }
        if (bo.getPid() == null) {
            log.error("FeedbackCategoryServiceImpl===>updateFeedbackCategory:" + ResponseStatusEnum.FEEDBACK_CATEGORY_PARENT_LABEL_ERROR);
            GraceJSONResult.errorCustom(ResponseStatusEnum.FEEDBACK_CATEGORY_PARENT_LABEL_ERROR);
        }
        if (bo.getCateName() == null) {
            log.error("FeedbackCategoryServiceImpl===>updateFeedbackCategory:" + ResponseStatusEnum.FEEDBACK_CATEGORY_NAME_ERROR);
            GraceJSONResult.errorCustom(ResponseStatusEnum.FEEDBACK_CATEGORY_NAME_ERROR);
        }
        FeedbackCategory feedbackCategory = new FeedbackCategory();
        if (bo.getPid() != 0) {
            FeedbackCategory category = this.getById(bo.getPid());
            if (category.getPid() != 0) {
                log.error("FeedbackCategoryServiceImpl===>updateFeedbackCategory:" + ResponseStatusEnum.FEEDBACK_CATEGORY_ERROR);
                GraceException.display(ResponseStatusEnum.FEEDBACK_CATEGORY_ERROR);
            } else {
                feedbackCategory.setPath("/" + bo.getPid() + "/");
            }
        ...
        if (!flag) {
            log.error("FeedbackCategoryServiceImpl===>updateFeedbackCategory:" + ResponseStatusEnum.SYSTEM_OPERATION_ERROR);
            GraceJSONResult.errorCustom(ResponseStatusEnum.SYSTEM_OPERATION_ERROR);
        }
    }
    ...
    public void deleteFeedbackCategoryById(Integer feedbackCategoryId) {
        if (feedbackCategoryId == null) {
            ...
            log.error("FeedbackCategoryServiceImpl===>deleteFeedbackCategoryById:" + ResponseStatusEnum.FEEDBACK_CATEGORY_ID_ERROR);
        }
        FeedbackCategory feedbackCategory = new FeedbackCategory();
        ...
        boolean flag = this.updateById(feedbackCategory);
        if (!flag) {
            log.error("FeedbackCategoryServiceImpl===>deleteFeedbackCategoryById:" + ResponseStatusEnum.SYSTEM_OPERATION_ERROR);
            GraceJSONResult.errorCustom(ResponseStatusEnum.SYSTEM_OPERATION_ERROR);
        }
    }
